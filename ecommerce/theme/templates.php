...
<head>
    ...
    <title>Ram Dale | E-Junkshop</title>
...
<body style="background-color:white" onload="totalprice()" >
  ...
  <header id="header"><!--header-->
          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li><a href="#"><i class="fa fa-phone"></i> 09672871435</a></li>
                <li><a href="#"><i class="fa fa-envelope"></i> Ramdalejunkshopp@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-md-4 clearfix">
            <div class="logo pull-left">
              <a href="<?php echo web_root?>"><img src="images/home/image1.png" alt="" /></a>
            </div> 
          </div>
        ...
        <div class="row">
          <div class="col-sm-2">
            <div class="companyinfo">
              <h2><span>Ramdale</span><br>JunkShop</br></h2>
          ...
          <div class="col-sm-3">
            <div class="address">
              ...
              <p>Santiago, Santo Tomas Batangas</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <p class="pull-left">Modified by <span><a href="https://bit.ly/2LPn9Wu">Dale,Denzel & Dave</a></span></p>
          <p class="pull-right">Designed by <span><a target="_blank" href="http://www.themeum.com">group 3</a></span></p>
        </div>
      </div>
    </div>
