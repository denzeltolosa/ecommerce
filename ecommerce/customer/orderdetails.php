      ...
      <div class="table-responsive cart_info"> 
              ...
              ?>
                         ...
                         <!-- <td></td> -->
                          ...
                          <td><?php echo $_SESSION['gcCart'][$i]['qty']; ?></td>
                          <td>&#8369 <?php echo  $result->PRODISPRICE ?></td>
                          <td style="top: 5px;" >&#8369<output><?php echo $_SESSION['gcCart'][$i]['price']; ?></output></td>
                        </tr>
              <?php
         ...
         <div class="row">
              ...
              <div class="form-group">
                  ...
                  <div class="radio" >
                   ...
                   <div class="radio" >
                      <label >
                          <input type="radio"  class="paymethod" name="paymethod" id="deliveryfee" value="GCASH" data-toggle="collapse"  data-parent="#accordion" data-target="#collapseOne" >GCASH
              </label>
