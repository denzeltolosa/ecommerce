...
<link href="<?php echo web_root; ?>admin/css/dashboard.css" rel="stylesheet">
        ...
        <nav class="navbar navbar-default navbar-static-top  " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                 ...
                 <a class="navbar-brand"  href="<?php echo web_root; ?>admin/dashboard/index.php" >RAMDALE ADMIN PAGE</a>
            </div>
                 ...
                 <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li><a href="<?php echo web_root; ?>admin/category/index.php?view=add"><i class="fa fa-list-alt  fa-fw"></i> Category</a>
                            ...
                            # code...
                        ?>
                         <li><a href="<?php echo web_root; ?>admin/admin/index.php?view=add"><i class="fa fa-group  fa-fw"></i> Administrator</a>
                            </li>
                        <?php }?>
...
?> 
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        Welcome, <?php echo $_SESSION['U_NAME']; ?> <img title="profile image" width="23px" height="17px" src="<?php echo web_root.'admin/admin/'.$singleuser ->USERIMAGE ?>">  
                    ...
                    <ul class="dropdown-menu dropdown-acnt">
                          ...
                          <div class="divpic"> 
                            <a href="" data-target="#usermodal"  data-toggle="modal" > 
                                <img title="profile image" width="70" height="80" src="<?php echo web_root.'admin/admin/'.$singleuser ->USERIMAGE ?>">  
                            </a>
                          </div> 
                    

                      <div class="divtxt">
                        <li><a href="<?php echo web_root; ?>admin/admin/index.php?view=edit&id=<?php echo $_SESSION['USERID']; ?>"> <?php echo $_SESSION['U_NAME']; ?> </a>
                      <li><a title="Edit" href="<?php echo web_root; ?>admin/admin/index.php?view=edit&id=<?php echo $_SESSION['USERID']; ?>" >Edit My Profile</a>
                                    
                        </li>
                          </li>
                           <li><a href="<?php echo web_root; ?>logout.php"><i class="fa fa-sign-out fa-fw"></i> Log Out</a>
                        </li> 
                  </div>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                       ...
                       <li>
                        ...
                        <li>
                             <a href="<?php echo web_root; ?>admin/customer/index.php"><i class="fa fa-user fa-fw"></i> Users </a>
                        ...
                        ?>
                         <li>
                             <a href="<?php echo web_root; ?>admin/settings/index.php" ><i class="fa fa-list-alt fa-fw"></i> Update</a>
            
                        </li>
                      
                          <li>
                            <a href="<?php echo web_root; ?>admin/admin/index.php" ><i class="fa fa-group fa-fw"></i> Administrators </a>
                         ...
                         <li>
                             <a href="<?php echo web_root; ?>admin/logs/index.php"><i class="fa fa-barcode fa-fw"></i> Logs </a>
                    ...
                    <div class="modal fade" id="usermodal" tabindex="-1">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="<?php echo web_root; ?>admin/admin/controller.php?action=photos" enctype="multipart/form-data" method=
                                "post">
