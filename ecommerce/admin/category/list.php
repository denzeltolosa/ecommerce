				  ...
				  <thead>
				  	<tr>
				  		...
				  		<th>
				  		 ...
				  		 Category</th> 
				  		 <th width="10%" style="align-items:center">Action</th>
				  	</tr>	
				  </thead> 
				  <tbody>
				  	<?php 
						...
						foreach ($cur as $result) {
				  		...
				  		echo '<td align="center"><a title="Edit" href="index.php?view=edit&id='.$result->CATEGID.'" class="btn btn-primary btn-xs  ">  <span class="fa fa-edit fw-fa"></a>
				  		     <a title="Delete"  href="controller.php?action=delete&id='.$result->CATEGID.'" class="btn btn-danger btn-xs  ">  <span class="fa  fa-trash fw-fa "></a></td>';
				  		// echo '<td></td>';
				  		echo '</tr>';
				  	} 
				  	?>
