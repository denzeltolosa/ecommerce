				  		...
				  		echo '<td >'. $result->ORDEREDSTATS.'</td>';
				  		 ...
				  		 if($result->ORDEREDSTATS=='Pending'){
				  				...
				  				<a href="controller.php?action=edit&id='.$result->ORDEREDNUM.'&actions=confirm"  class="btn btn-primary btn-xs">Confirm</a></td>';
				  	 			...
				  	 			echo '<td><a href="controller.php?action=edit&id='.$result->ORDEREDNUM.'&actions=prepare"  class="btn btn-primary btn-xs">Prepare</a></td>';
				  		}elseif($result->ORDEREDSTATS=='Prepared'){
				  	 			echo '<td><a href="controller.php?action=edit&id='.$result->ORDEREDNUM.'&actions=deliver"  class="btn btn-primary btn-xs">Deliver</a></td>';
				  		 }elseif($result->ORDEREDSTATS=='Delivering'){
				  	 			echo '<td><a href="controller.php?action=edit&id='.$result->ORDEREDNUM.'&actions=complete"  class="btn btn-success btn-xs">Complete</a>
				  		 		<a href="controller.php?action=edit&id='.$result->ORDEREDNUM.'&actions=return" class="btn btn-danger btn-xs">Return</a></td>';
			  	 	 	}elseif($result->ORDEREDSTATS=='Delivered'){
			  	 	 		  echo '<td> <a  href="controller.php?action=edit&id='.$result->ORDEREDNUM.'&actions=complete"  class="btn btn-success btn-xs"disabled>Complete</a></td>';
